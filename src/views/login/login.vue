<template>
  <div class="login-wrap">
    <el-form ref="ruleForm" label-position="left" :model="ruleForm" :rules="rules" label-width="0px" class="demo-ruleForm login-container">
      ...
      <el-checkbox v-model="rememberpwd" class="remember">记住密码</el-checkbox>
      <el-form-item style="width:100%;">
        <el-button type="primary" style="width:100%;" :loading="logining" @click.native.prevent="handleLogin">登录</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
